...
namespace CsharpEgitimKampi301.EFProject
{
    public partial class FrmLocation : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            db.SaveChanges();
            MessageBox.Show("Başarıyla Eklendi", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            db.SaveChanges();
            MessageBox.Show("Başarıyla Silindi", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
        }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            db.SaveChanges();
            MessageBox.Show("Başarıyla Güncellendi", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }
    }
}
